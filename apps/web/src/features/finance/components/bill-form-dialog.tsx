    ...
    <Dialog open={open} onOpenChange={(o) => { onOpenChange?.(o); if (!o) resetForm() }}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        >
          ...
          <motion.div variants={preset.field} className="grid grid-cols-2 gap-3">
          ...
          <motion.div variants={preset.field} className="flex items-center gap-2">
